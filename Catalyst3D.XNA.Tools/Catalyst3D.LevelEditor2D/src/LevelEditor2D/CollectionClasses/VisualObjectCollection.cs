...
namespace LevelEditor2D.CollectionClasses
{
  ...
  public class VisualObjectCollection : CollectionBase, ICustomTypeDescriptor
  {
    ...
    public PropertyDescriptorCollection GetProperties()
    {
      ...
      for (int i = 0; i < List.Count; i++)
      {
        ...
        VisualObjectCollectionPropertyDescriptor pd = new VisualObjectCollectionPropertyDescriptor(this, i);
				pds.Add(pd);
      }
      return pds;
  ...
  public class VisualObjectCollectionPropertyDescriptor : PropertyDescriptor
  {
    private readonly VisualObjectCollection collection;
    private readonly int index = -1;

    public VisualObjectCollectionPropertyDescriptor(VisualObjectCollection coll, int idx)
      : base("#" + idx, null)
    {
      collection = coll;
      index = idx;
